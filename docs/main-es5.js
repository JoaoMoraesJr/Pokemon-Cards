...
var PokemonsComponent = /** @class */ (function () {
    function PokemonsComponent(service, alertService) {
    ...
    PokemonsComponent.prototype.addCards = function (aux) {
    ...
    PokemonsComponent.prototype.removeCard = function (index) {
        this.alertService.info('Card removed');
        this.deck.splice(index, 1);
    };
    PokemonsComponent.prototype.getTypes = function () {
        var _this = this;
        this.service.getTypes().subscribe(function (res) {
            _this.types = res['types'];
        });
    };
    PokemonsComponent.prototype.getAllPokemons = function () {
        var _this = this;
        this.cardsImage = [];
        this.service.getAllPokemons().subscribe(function (res) {
            for (var i = 0; i < 1000; i++) {
                _this.cardsImage.push(res['cards'][String(i)]['imageUrlHiRes']);
            }
            _this.cards = res['cards']['0']['imageUrlHiRes'];
        });
    };
    PokemonsComponent.prototype.getPokemonByType = function (aux) {
        var _this = this;
        this.cardsImage = [];
        this.service.getPokemonByTypes(aux).subscribe(function (res) {
            for (var i = 0; i < 1000; i++) {
                _this.cardsImage.push(res['cards'][String(i)]['imageUrlHiRes']);
            }
        });
    };
    PokemonsComponent.ctorParameters = function () { return [
...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.getPokemon = function (aux) {
        return this.http.get("" + this.specificPokemon + aux);
    };
    PokemonsService.prototype.getAllPokemons = function () {
        return this.http.get(this.apiEndPoint);
    };
    PokemonsService.prototype.getTypes = function () {
        return this.http.get(this.pokemonTypes);
    };
    PokemonsService.prototype.getPokemonByTypes = function (aux) {
